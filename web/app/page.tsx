...
export default function HomePage() {
  return (
    <div className="space-y-16 py-12">
      <section className="flex flex-col items-start gap-12 lg:flex-row lg:items-center">
        <div className="flex-1 space-y-6">
          ...
          <p className="text-lg text-slate-300">
            DisasterVault combines Cadence smart contracts, Flow Actions, and GPT-4 verification to send funds to the Red Cross
            minutes after catastrophic earthquakes strike. Deposit once, then let the chain respond while you sleep.
          </p>
